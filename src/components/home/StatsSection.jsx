      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-start gap-4 mb-12 pt-2 md:mb-16 pl-2">
          ...
          <button 
            className="group flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl text-sm font-bold transition-all duration-300 hover:scale-110 active:scale-95 border border-gray-200 bg-white hover:bg-gray-50 text-gray-800 backdrop-blur-md hover:shadow-xl"
          >
            View Details
